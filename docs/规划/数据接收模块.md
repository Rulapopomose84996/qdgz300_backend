...
> 使用说明：本文是规划文档，不是代码实况文档。生成任务、评估差距或交给 AI 续写时，必须同时对照 `src/m01_receiver/app_init.cpp`、`src/m01_receiver/app_run.cpp`、`src/m01_receiver/pipeline/rx_stage.cpp` 和 `docs/设计/源码设计/m01_receiver.md`；若本文与代码不一致，以代码为准。
